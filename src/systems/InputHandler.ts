    ...
    private updateSubmenu(tool: string): void {
        ...
        const submenus: Record<string, Array<{ id: string; name: string; cost: number; icon: string; biome?: string }>> = {
            ...
            foliage: [
                ...
                // Deciduous Forest
                { id: 'deciduous_bush', name: 'Deciduous Bush', cost: 35, icon: '🌿', biome: 'deciduous_floor' },
                { id: 'bonsai', name: 'Bonsai', cost: 75, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'maple_tree', name: 'Maple Tree', cost: 100, icon: '🍁', biome: 'deciduous_floor' },
                { id: 'snowbell_tree', name: 'Snowbell Tree', cost: 120, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'wild_olive', name: 'Wild Olive Tree', cost: 120, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'elm_tree', name: 'Elm Tree', cost: 125, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'gingko_tree', name: 'Gingko Tree', cost: 125, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'thornless_mesquite', name: 'Thornless Mesquite', cost: 125, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'pacific_dogwood', name: 'Pacific Dogwood', cost: 125, icon: '🌸', biome: 'deciduous_floor' },
                { id: 'weeping_willow', name: 'Weeping Willow', cost: 130, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'japanese_maple', name: 'Japanese Maple', cost: 135, icon: '🍁', biome: 'deciduous_floor' },
                { id: 'birch_tree', name: 'Birch Tree', cost: 145, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'white_oak', name: 'White Oak Tree', cost: 150, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'cherry_tree', name: 'Cherry Tree', cost: 175, icon: '🌸', biome: 'deciduous_floor' },
                { id: 'glossopteris', name: 'Glossopteris', cost: 185, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'magnolia_tree', name: 'Magnolia Tree', cost: 185, icon: '🌸', biome: 'deciduous_floor' },
                { id: 'trembling_aspen', name: 'Trembling Aspen', cost: 200, icon: '🌳', biome: 'deciduous_floor' },
                { id: 'globe_willow', name: 'Globe Willow', cost: 210, icon: '🌳', biome: 'deciduous_floor' },
                // Coniferous Forest
                { id: 'pine_bush', name: 'Pine Bush', cost: 85, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'pine_tree', name: 'Pine Tree', cost: 100, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'fir_tree', name: 'Fir Tree', cost: 125, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'chinese_fir', name: 'Chinese Fir', cost: 125, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'yew_tree', name: 'Yew Tree', cost: 125, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'dawn_redwood', name: 'Dawn Redwood', cost: 140, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'yellow_cedar', name: 'Yellow Cedar', cost: 145, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'spruce_tree', name: 'Spruce Tree', cost: 145, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'lodgepole_pine', name: 'Lodgepole Pine', cost: 160, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'western_red_cedar', name: 'Western Red Cedar', cost: 165, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'norfolk_island_pine', name: 'Norfolk Island Pine', cost: 170, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'club_moss', name: 'Club Moss', cost: 190, icon: '🌿', biome: 'coniferous_floor' },
                { id: 'walchian_conifer', name: 'Walchian Conifer', cost: 200, icon: '🌲', biome: 'coniferous_floor' },
                { id: 'lepidodendron', name: 'Lepidodendron', cost: 210, icon: '🌲', biome: 'coniferous_floor' },
                // Rainforest
                { id: 'rainforest_stump', name: 'Rainforest Stump', cost: 35, icon: '🪵', biome: 'rainforest_floor' },
                { id: 'rainforest_fern', name: 'Rainforest Fern', cost: 45, icon: '🌿', biome: 'rainforest_floor' },
                { id: 'rainforest_bush', name: 'Rainforest Bush', cost: 50, icon: '🌿', biome: 'rainforest_floor' },
                { id: 'rafflesia', name: 'Rafflesia', cost: 80, icon: '🌺', biome: 'rainforest_floor' },
                { id: 'fern_bush', name: 'Fern Bush', cost: 100, icon: '🌿', biome: 'rainforest_floor' },
                { id: 'giant_ficus_tree', name: 'Giant Ficus Tree', cost: 115, icon: '🌳', biome: 'rainforest_floor' },
                { id: 'foxtail_palm_tree', name: 'Foxtail Palm Tree', cost: 120, icon: '🌴', biome: 'rainforest_floor' },
                { id: 'ulmo_tree', name: 'Ulmo Tree', cost: 120, icon: '🌳', biome: 'rainforest_floor' },
                { id: 'fallen_rainforest_tree', name: 'Fallen Rainforest Tree', cost: 120, icon: '🪵', biome: 'rainforest_floor' },
                { id: 'orchid_tree', name: 'Orchid Tree', cost: 125, icon: '🌸', biome: 'rainforest_floor' },
                { id: 'durian_tree', name: 'Durian Tree', cost: 125, icon: '🌳', biome: 'rainforest_floor' },
                { id: 'leptocycas_tree', name: 'Leptocycas Tree', cost: 125, icon: '🌴', biome: 'rainforest_floor' },
                { id: 'thouarsus_cycad_tree', name: 'Thouarsus Cycad Tree', cost: 140, icon: '🌴', biome: 'rainforest_floor' },
                { id: 'mangrove_tree', name: 'Mangrove Tree', cost: 155, icon: '🌳', biome: 'rainforest_floor' },
                { id: 'llala_palm_tree', name: 'Llala Palm Tree', cost: 175, icon: '🌴', biome: 'rainforest_floor' },
